function [svm_struct, svIndex] = svmtr(training, groupnames, varargin)
...
%   $Revision: 1.1.12.15 $  $Date: 2012/05/03 23:56:57 $
...
autoScale = bioinfoprivate.opttf(autoScale,'autoscale',mfilename);
